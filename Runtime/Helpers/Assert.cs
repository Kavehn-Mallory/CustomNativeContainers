...
namespace BonnFireGames.CustomNativeContainers.Helpers
{
    /// <summary>
    /// This is a copy of the Assert class in the Entities package. Due to the limited use of entity specific features, I decided to copy the contents of Unity.Assertions.Assert instead of using the entities package.
